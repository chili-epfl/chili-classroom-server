...
if (Meteor.isClient) {
  ...
  Template.demo.rendered = function() {
      ...
      function setupStartGame() {
          ...
          polygon1 = game.add.sprite(game.world.randomX, game.world.randomY);
          polygon2 = game.add.sprite(game.world.randomX, game.world.randomY);
          polygon3 = game.add.sprite(game.world.randomX, game.world.randomY);
          polygon4 = game.add.sprite(game.world.randomX, game.world.randomY);
